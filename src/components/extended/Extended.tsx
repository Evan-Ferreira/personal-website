        ...
        <div className="flex flex-row w-screen h-screen bg-yellow-200 items-center justify-start relative">
            ...
            <div className="flex flex-col justify-center items-start w-5/12 space-y-20">
                <p className="font-SourceSerif4ExtraLight text-xl">
                    ...
                    University, previously ranked 3rd in Canada. In fact, I'm
                    passionate about almost all sports including ultimate
                    frisbee, cross country, skiing, and spikeball. Alongside my
                    love for sports, I am enthusiastic about entrepreneurship
